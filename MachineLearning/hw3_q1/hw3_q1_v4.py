# Modifying hw3_q1_v3.1
# Remove tf.summary.scalar('out0', prediction[0][0]) etc.
# 
...
# add output layer
l1 = add_layer(xs*5, 8, n_hid_nodes, 'hidden_layer', activation_function=tf.nn.relu)
